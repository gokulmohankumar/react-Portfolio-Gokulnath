...
import profilePic from '../assets/Assests/kevinRushProfile.png'
      ...
      <div className='flex flex-wrap '>
          <div className='w-full lg:w-1/2 '>
             <div className='flex flex-col items-center lg:items-start'>
              ...
              initial='hidden'
              animate='visible'
              className='pb-16 text-6xl ml-[25px] font-thin tracking-tight lg:mt-16 lg:text-8xl '>Gokulnath M</motion.h1>
              <motion.span
              ...
              initial='hidden'
              animate='visible'
              className='my-2 max-w-xl py-6 font-light ml-[40px]  text-white text-lg tracking-normal'>{HERO_CONTENT}</motion.p>
             </div>
          </div>
